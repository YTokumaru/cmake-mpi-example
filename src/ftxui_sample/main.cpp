...
// configuration step. It creates a namespace called `cmake_mpi_example`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", cmake_mpi_example::cmake::project_name, cmake_mpi_example::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", cmake_mpi_example::cmake::project_version);
      return EXIT_SUCCESS;
    }
